...
export const audioTheme: Record<Theme, { pos: number, color: string }[]> = {
  apple: [
    { pos: 0.1, color: '#61bb46' },
  ...
  cool: [
    { pos: 0, color: 'hsl( 208, 0%, 100% )' },
    { pos: 1, color: 'hsl( 208, 100%, 35% )' }
  ],
  dusk: [
  ...
  rainbow: [
    { pos: 0.1, color: '#9f49ac' },
    { pos: 0.25, color: '#476EAF' },
    { pos: 0.33, color: '#179067' },
    { pos: 0.56, color: '#EDE604' },
    { pos: 0.68, color: '#FFCC00' },
    { pos: 0.76, color: '#FEAC00' },
    { pos: 0.88, color: '#FF8100' },
    { pos: 0.92, color: '#FF5800' },
    { pos: 1, color: '#FF3BA7' }
  ]
}
